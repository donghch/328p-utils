...
static void lcd1602_set_data(uint8_t data) {
	
	LCD1602_D7_P = ((data >> 7) << LCD1602_D7_PN) | LCD1602_D7_P;
	LCD1602_D6_P = ((data >> 6) << LCD1602_D6_PN) | LCD1602_D6_P;
	LCD1602_D5_P = ((data >> 5) << LCD1602_D5_PN) | LCD1602_D5_P;
	LCD1602_D4_P = ((data >> 4) << LCD1602_D4_PN) | LCD1602_D4_P;
	LCD1602_D3_P = ((data >> 3) << LCD1602_D3_PN) | LCD1602_D3_P;
	LCD1602_D2_P = ((data >> 2) << LCD1602_D2_PN) | LCD1602_D2_P;
	LCD1602_D1_P = ((data >> 1) << LCD1602_D1_PN) | LCD1602_D1_P;
	LCD1602_D0_P = ((data >> 0) << LCD1602_D0_PN) | LCD1602_D0_P;
